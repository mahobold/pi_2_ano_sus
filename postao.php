  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="card" style="width: 18rem;"> <!-- Card Medico plantão do dia -->
        <img src="https://vivamais.cemigsaude.org.br/wp-content/uploads/2019/10/original-a5ec3913e1ae9cb2c075b3f2ab99e797.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Medico plantão do dia.</h5>
          <p class="card-text">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
              <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
            </svg> Dr. Crawford Long.
          </p>
          <p class="card-text">
      ...
      <div class="card" style="width: 18rem;"> 
        <img src="https://i1.sndcdn.com/artworks-9lQ8NJb5hQjnnFNd-kSs9TQ-t500x500.jpg" class="card-img-top" alt="...">
        <div class="card-body">
