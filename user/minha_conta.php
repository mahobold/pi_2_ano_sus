...
if(isset($_SESSION['login_nome'])){
    ...
    $stmt = $mysqli->prepare("SELECT * FROM pi_2023_sus_pessoas WHERE id_pessoa = ? LIMIT 1");
    ...
    if (isset($_FILES["foto"]) && $_FILES["foto"]["error"] == 0) {
        ...
        $diretorioUpload = "../img/foto_perfil/";
...
<body>
    <?php include("../static/menu_page.php"); ?>

    <div class="container profile-container">
        <div class="text-center mb-4">
            <?php
                if(isset($_SESSION['login_nome'])){
                    $imgPath = isset($usuario["camimg"]) && !empty($usuario["camimg"]) ? $usuario["camimg"] : '../img/foto_perfil/foto_teste.png';
                    ...
                    if (file_exists($imgPath)) {
                        ...
                        echo "<img class='profile-picture' src='../img/foto_perfil/foto_teste.png' alt='Foto de perfil'>";
        ...
        <form action="minha_conta.php" method="post" enctype="multipart/form-data" class="mb-4">
            <div class="mb-3">
