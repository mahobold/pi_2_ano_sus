...
<nav class="navbar navbar-dark ">
  ...
  <?php  
<<<<<<<< HEAD:menu.php
        $logado = '<a href="../user/minhaconta.php"><i class="bi bi-person-check"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
========
        $logado = '<a href="../user/minha_conta.php"><i class="bi bi-person-check"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
>>>>>>>> Dieimes:static/menu_index.php
    ...
    <div class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="user/minha_conta.php">Minha conta</a>
          </li>
          <li class="nav-item">
