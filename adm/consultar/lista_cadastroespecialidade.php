          ...
          <h1>Lista - Especialidades</h1>
            ...
            <table class="table table-striped">
                ...
                <tr>
                   ...
                   <th><a class="btn btn-primary" href="../alterar/alterarespecialidade.php?id_especialidade=<?php echo $especialidades['id_especialidade'];?>">Alterar</a></th>
                   <th><a class="btn btn-danger" href="../deletar/deletarespecialidade.php?codigo_especialidade=<?php echo $especialidades['id_especialidade'];?>">Deletar</a></th>
                </tr>
                <?php
                        }
                    ?>
            ...
            <a class="btn btn-primary" href="../cadastrar/cadastro_especialidade.php">Voltar</a>
        </div>
    </body>
