<?php
    ...
    $consultar_banco = "SELECT * FROM nefro";
...
<html lang="pt-br">
    <head>
        ...
        <title>Consultas - Nefrologista</title>
    </head>
    ...
    ?>
        <div class="container">
          <h1>Consultas - Nefrologista</h1>
            <table class="table table-striped">
                <tr>
                    <th>Id Paciente:</th>
                    <th>Teve cólica renal?</th>
                    <th>Possui dificuldade para urinar ou urinou sangue?</th>
