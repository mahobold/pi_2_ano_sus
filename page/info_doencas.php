...
<body>
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas:</h1>
  <div class="texto">
    <p class="d-flex justify-content-center" >Em muitos casos, a condição é assintomática, ou seja, não apresenta sintomas; </p>
    <p class="d-flex justify-content-center" >Febre, aparecimento de gânglios;</p>
    <p class="d-flex justify-content-center">crescimento do baço e do fígado;</p>
    <p class="d-flex justify-content-center">Alterações elétricas do coração e/ou inflamação das meninges nos casos graves;</p>
    <p class="d-flex justify-content-center">Quadros de diarreia frequentes;</p>
    <p class="d-flex justify-content-center">Sinusite;</p>
    <p class="d-flex justify-content-center">Pneumonia;</p>
    <p class="d-flex justify-content-center">Quadros de herpes simples (boca).</p>
  </div>
  ...
  <div class="container d-flex justify-content-center">
    <p>É uma doença causada pelo novo tipo de coronavírus identificado neste ano, que leva o nome de SARS-CoV-2.
      ...
      <h1 class="sintomas d-flex justify-content-center">Sintomas:</h1>
        ...
        <div class="texto">
          <div class="row">
          <p class="d-flex justify-content-center">Febre.</p>
          <p class="d-flex justify-content-center">Mal estar e Dores no corpo.</p>
          <p class="d-flex justify-content-center">Falta de ar.</p>
          <p class="d-flex justify-content-center">Dor de garganta.</p>
          <p class="d-flex justify-content-center">Coriza ou nariz entupido.</p>
          <p class="d-flex justify-content-center">Diarreia.</p>
          <p class="d-flex justify-content-center">Cansaço.</p>
          <p class="d-flex justify-content-center">Dor de cabeça.</p>
          </div>
        </div>
  ...
  <p>A dengue é uma doença febril aguda, sistêmica e dinâmica, variando desde casos assintomáticos a quadros graves, inclusive óbitos. Nos casos sintomáticos pode apresentar três fases clínicas: febril, crítica e de recuperação.
    ...
    <h1 class="sintomas d-flex justify-content-center">Sintomas:</h1>
    <div class="texto">
    <p class="d-flex justify-content-center">Febre alta > 38.5ºC;</p>
    <p class="d-flex justify-content-center">Dores musculares intensas;</p>
    <p class="d-flex justify-content-center">Dor ao movimentar os olhos;</p>
    <p class="d-flex justify-content-center">Mal estar;</p>
    <p class="d-flex justify-content-center">Falta de apetite;</p>
    <p class="d-flex justify-content-center">Dor de cabeça;</p>
    <p class="d-flex justify-content-center">Manchas vermelhas no corpo.</p>
  </div>
  ...
  <p>Uma infecção viral comum que pode ser fatal, especialmente em grupos de alto risco.
    ...
    <div class="texto">
    <p class="d-flex justify-content-center">Dor de garganta;</p>
    <p class="d-flex justify-content-center">Tosse;</p>
    <p class="d-flex justify-content-center">Dor no corpo;</p>
    <p class="d-flex justify-content-center">Dor de cabeça;</p>
    <p class="d-flex justify-content-center">Febre.</p>
  </div>
 ...
 <div class="container">
  <div class="row d-flex justify-content-center">
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Evite abraços e apertos de mão.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/gripe2.jfif" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Fique em casa se estiver doente e se precisar, peça ao seu médico um atestado.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/gripee2.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Por favor, não compartilhe os seus objetos pessoais.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/gripe5.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Vacine-se contra a gripe.</p>
 ...
 <div class="container d-flex justify-content-center">
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas:</h1>
  <div class="texto">
  <p class="d-flex justify-content-center"> Os sintomas variam muito ou podem não ocorrer. Alguns pacientes têm inchaços anormais, febres inexplicáveis, sudorese noturna ou perda de peso involuntária.</p>
  <p class="d-flex justify-content-center">Cansaço inexplicável e perda de energia.</p>
  <p class="d-flex justify-content-center"> Hematomas frequentes.</p>
  <p class="d-flex justify-content-center"> Sangramento anormal. </p>
  <p class="d-flex justify-content-center">Dor continua. </p>
  <p class="d-flex justify-content-center"> Febre ou sintomas inespecíficos que não melhoram.</p>
  <p class="d-flex justify-content-center"> Dores de cabeça frequentes, muitas vezes com vômitos.</p>
  <p class="d-flex justify-content-center"> Alterações na visão ou mudanças repentinas de comportamento.</p>
  <p class="d-flex justify-content-center">Perda de apetite ou perda de peso não planejada. </p>
  <p class="d-flex justify-content-center"> Aparecimento de pintas novas ou manchas na pele, que mudam de tamanho, forma ou cor. </p>
  </div>
 ...
 <div class="container">
  <div class="row d-flex justify-content-center">
    ...
    <div class="card" style="width: 18rem;">
      <img src="../img/cancerr4.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Evite a ingestão de bebidas alcoólicas.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/cancer5.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Pratique atividades físicas diariamente.</p>
 ...
 <div class="container d-flex justify-content-center">
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas</h1>
  <div class="texto">
  <p class="d-flex justify-content-center">Fome frequente;</p>
  <p class="d-flex justify-content-center">Sede constante ;</p>
  <p class="d-flex justify-content-center">Vontade de urinar diversas vezes ao dia ;</p>
  <p class="d-flex justify-content-center"> Perda de peso; </p>
  <p class="d-flex justify-content-center">Fraqueza ;</p>
  <p class="d-flex justify-content-center">Fadiga;</p>
  <p class="d-flex justify-content-center"> Mudanças de humor ;</p>
  <p class="d-flex justify-content-center">Náusea e Vômito. </p>
  </div>
 ...
 <div class="container">
  <div class="row d-flex justify-content-center">
    ...
    <div class="card" style="width: 18rem;">
      <img src="../img/diabetes1.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Manter o peso normal.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/diabetess2.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Controlar a pressão arterial.</p>
    ...
    <div class="card" style="width: 18rem;">
      <img src="../img/diabetes3.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Evitar medicamentos que potencialmente possam agredir o pâncreas.</p>
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas </h1>
  <div class="texto">
  <p class="d-flex justify-content-center"> Dores de cabeça;</p>
  <p class="d-flex justify-content-center">Alterações visuais; </p>
  <p class="d-flex justify-content-center">Zumbido no ouvido;</p>
  <p class="d-flex justify-content-center">Tontura ; </p>
  <p class="d-flex justify-content-center">Fraqueza ;</p>
  <p class="d-flex justify-content-center"> Dores no peito ;</p>
  <p class="d-flex justify-content-center">Ânsia e vômitos,entre outros.</p>
  </div>
  ...
  <div class="row d-flex justify-content-center">
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Não abusar do sal (utilize outros temperos que ressaltam o sabor dos alimentos).</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/hipertensaoo1.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Mantenha exames em dia.</p>
    ...
    <div class="card" style="width: 18rem;">
      <img src="../img/hipertensaoo6.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Evitar alimentos gordurosos.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/hipertensaoo4.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Elimine o estresse.</p>
 ...
 <div class="container d-flex justify-content-center">
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas </h1>
  <div class="texto">
  <p class="d-flex justify-content-center">Tosse, especialmente durante a noite ou após a realização de algum esforço físico;</p>
  <p class="d-flex justify-content-center">Dificuldade para respirar;</p>
  <p class="d-flex justify-content-center">Dores pelo tórax e pelas costas;</p>
  <p class="d-flex justify-content-center">Cansaço;</p>
  <p class="d-flex justify-content-center">Chiado, entre outros.</p>
  </div>
  ...
  <div class="row d-flex justify-content-center"">
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Mantenha o ambiente limpo.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/asma2.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Evite acúmulo de sujeira ou poeira.</p>
    ...
    <div class="card" style="width: 18rem;">
      <img src="../img/asma4.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Tome a vacina da gripe.</p>
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas </h1>
  <div class="texto">
  <p class="d-flex justify-content-center">Problemas com memorização; </p>
  <p class="d-flex justify-content-center">Esquecimento de palavras;</p>
  <p class="d-flex justify-content-center">Esquecer como fazer tarefas do dia a dia;</p>
  <p class="d-flex justify-content-center">Agitação e inquietação;</p>
  <p class="d-flex justify-content-center">Mudanças de humor;</p>
  <p class="d-flex justify-content-center">Perda de interesse por tarefas que antes eram apaixonantes;</p>
  <p class="d-flex justify-content-center">Contrações musculares involuntárias;</p>
  <p class="d-flex justify-content-center">Alterações no padrão de apetite e/ou sono, entre outros.</p>
  </div>
 ...
 <div class="container">
  <div class="row d-flex justify-content-center">
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Manter a mente ativa.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/alzheimerr1.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Boa vida social.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/alzheimer3.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text">Bons hábitos alimentares e atividade física regular.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/alzheimer4.jpeg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text"> Controle colesterol e diabetes.</p>
 ...
 <div class="container d-flex justify-content-center">
  ...
  <h1 class="sintomas d-flex justify-content-center">Sintomas </h1>
  <div class="texto">
  <p class="d-flex justify-content-center">Perda súbita de habilidades, como a fala ou o ato de caminhar;</p>
  <p class="d-flex justify-content-center">Que pode ser em um só lado ou em ambos;</p>
  <p class="d-flex justify-content-center">Inquietação;</p>
  <p class="d-flex justify-content-center">Perda da visão; </p>
  <p class="d-flex justify-content-center">Formigamento nos membros, entre outros.</p>
  </div>
 ...
 <div class="container">
  <div class="row d-flex justify-content-center">
    ...
    <div class="card" style="width: 18rem;">
      <img src="../img/avc4.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text"> Manter alimentação saudável.</p>

      </div>
    </div>

    <div class="card" style="width: 18rem;">
      <img src="../img/avc5.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"></h5>
