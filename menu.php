...
<nav class="navbar navbar-dark ">
  <div class="container-fluid">    
      ...
      /*
        ...
        $nlogado ='<a href="login.php"><i class="bi bi-person"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
    ...
    <a class="navbar-brand" href="#">
      <img src="img/logot.png" width="250">
    </a>
  </div>
